...
- For those which are missing: Attach the distribution of the municipality with the nearest centroid
"""
...
def execute(context):
    ...
    if missing_communes:
        # Second, add missing municipalities by nearest neighbor
